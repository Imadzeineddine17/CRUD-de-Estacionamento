...
if(!empty($_GET['id']))
{
        ...
        if($result-> num_rows > 0)
        {
            ...
            //$modelo_veiculo =mysqli_real_escape_string($mysqli, $user_data['modelo_veiculo']);
            //$placa_veiculo =mysqli_real_escape_string($mysqli, $user_data['placa_veiculo']);
            //$ano_veiculo = mysqli_real_escape_string($mysqli,$user_data['ano_veiculo']);
            }
...
<body>
    <div class="box">
        <form action="saveEdit.php" method="POST">
            <fieldset>
                <a class= "button" href="sistema.php">↩</a>
                <br>
                ...
                <!-- <div class="inputBox">
                    ...
                    <input type="text" name="csenha" id="csenha" class="inputUser" value="<?php echo $csenha ?>" required>
                </div> -->
